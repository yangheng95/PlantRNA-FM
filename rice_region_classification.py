...
for gfm in [
    ...
    for seed in seeds:
        train_file = "RNA_Region_Classification/Rice/train.json"
        test_file = "RNA_Region_Classification/Rice/test.json"
        valid_file = "RNA_Region_Classification/Rice/valid.json"
